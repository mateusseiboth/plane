...
const APP_TITLE = "Avião Publish | Torne seus quadros do Avião públicos com um clique";
const APP_DESCRIPTION = "O Avião Publish é uma ferramenta de gestão de feedback de clientes.";
