...
import { getDate, getDateTime, renderFormattedPayloadDate, renderFormattedPayloadDateTime, getTabIndex } from "@plane/utils";
// components
...
export const IssueDefaultProperties = observer(function IssueDefaultProperties(props: TIssueDefaultPropertiesProps) {
  ...
  const canCreateLabel =
    projectId && allowPermissions(PROJECT_CONFIG_ROLES, EUserPermissionsLevel.PROJECT, workspaceSlug, projectId);

  const minDate = getDate(startDate);
  minDate?.setDate(minDate.getDate());

  const maxDate = getDateTime(targetDate);
