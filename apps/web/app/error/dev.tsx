      ...
      <div className="flex min-h-screen items-start justify-center bg-surface-2 p-6 transition-none">
        <div className="mt-12 w-full max-w-4xl space-y-4 transition-none">
          <Banner
            ...
            title="Resposta de erro da rota"
            animationDuration={0}
          />
        ...
        <div className="mt-12 w-full max-w-4xl space-y-4 transition-none">
          ...
          <Card variant={ECardVariant.WITH_SHADOW} className="!p-6 transition-none">
            <div className="space-y-4">
              ...
              {error.stack && (
                <div className="space-y-2">
                  <h3 className="text-13 font-medium tracking-wide text-tertiary uppercase">Pilha de chamadas</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-11 text-tertiary">
                  Esta visualização detalhada do erro só aparece em desenvolvimento. Em produção, os usuários verão
                  uma página de erro amigável.
                </p>
              </div>
            </div>
          </Card>
