...
export function LinkEditView({ viewProps }: LinkEditViewProps) {
  ...
  return (
    <div
      ...
      tabIndex={0}
    >
      <InputView label="URL" placeholder="Digite ou cole a URL" value={localUrl} onChange={setLocalUrl} autoFocus />
      <InputView label="Texto" placeholder="Digite o texto a exibir" value={localText} onChange={handleTextChange} />
