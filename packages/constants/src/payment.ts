/**
 * Copyright (c) 2023-present Avião Software, Inc. and contributors
...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "Avião Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for Avião Cloud",
    type: "BUSINESS",
    prices: [
      {
