...
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://www.qualitysistemas.com.br";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "suporte@qualitysistemas.com.br";
// links institucionais (herdados do upstream; apontam para o site do produto)
export const MARKETING_PRICING_PAGE_LINK = WEBSITE_URL;
export const MARKETING_CONTACT_US_PAGE_LINK = WEBSITE_URL;
export const MARKETING_PLANE_ONE_PAGE_LINK = WEBSITE_URL;
